...
bool visitar_c(const char* clave, void* dato, void* extra){
    if(*(int*) dato > *(int*) extra) return false;
...
static void prueba_abb_in_order(){
    ...
    char *clave1_ = "n1", *valor1_ = "4";
    char *clave2_ = "n2", *valor2_ = "6";
    char *clave3_ = "n3", *valor3_ = "1";
    char *clave4_ = "n4", *valor4_ = "23";
    char *clave5_ = "n5", *valor5_ = "15";
    char *clave6_ = "n6", *valor6_ = "5";
    char *clave7_ = "n7", *valor7_ = "21";
    char *clave8_ = "n8", *valor8_ = "3";
    char *clave9_ = "n9", *valor9_ = "27";
    char *clave10_ = "n10", *valor10_ = "11";

    abb_guardar(abb, clave1_,valor1_);
    abb_guardar(abb, clave2_,valor2_);
    abb_guardar(abb, clave3_,valor3_);
    abb_guardar(abb, clave4_,valor4_);
    abb_guardar(abb, clave5_,valor5_);
    abb_guardar(abb, clave6_,valor6_);
    abb_guardar(abb, clave7_,valor7_);
    abb_guardar(abb, clave8_,valor8_);
    abb_guardar(abb, clave9_,valor9_);
    abb_guardar(abb, clave10_,valor10_);

    int n_test = 0;
    abb_in_order(abb, visitar, &n_test);
    print_test("Itera todos los elementos del abb", n_test == 27);

    n_test = 0;
    abb_in_order(abb, visitar_c, &n_test);
    print_test("Itera los elementos del abb hasta la condicion de corte", n_test == 0);
